...
class HttpStatus {
  static const Continue = 100; //继续。客户端应继续其请求
  static const Switching = 101; //协议切换
  static const OK = 200; //成功
  static const CREATED = 201; //已创建
  static const Accepted = 202; //已接受
  static const NonAuthoritative = 203; //非授权信息
  static const NoContent = 204; //无内容
  static const ResetContent = 205; //重置内容
  static const PartialContent = 205; //部分内容.完成了部分
